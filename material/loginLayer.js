!window.WBtopGlobal_loginLayer && (window.WBtopGlobal_loginLayer = function () {
    ...
    STK.register("core.dom.cssText", function (a) {
        var b = function (a) {
                ...
                return b
            }, d = {webkit: "-webkit-", presto: "-o-", trident: "-ms-", gecko: "-moz-"}[a.core.util.browser.CORE],
    ...
    STK.register("core.util.color", function (a) {
        var b = /^#([a-fA-F0-9]{3,8})$/, c = /^rgb[a]?\s*\((\s*([0-9]{1,3})\s*,){2,3}(\s*([0-9]{1,3})\s*)\)$/,
            d = /([0-9]{1,3})/ig, e = /([a-fA-F0-9]{2})/ig, f = a.core.arr.foreach, g = function (a) {
                var g = [], h = [];
                if (b.test(a)) {
                    h = a.match(b);
    ...
    STK.register("core.ani.tween", function (a) {
        var b = a.core.ani.tweenArche, c = a.core.arr.foreach, d = a.core.dom.getStyle, e = a.core.func.getType,
            f = a.core.obj.parseParam, g = a.core.json.merge, h = a.core.util.color, i = function (a) {
                ...
                opacity: function (a, b, c, d) {
                    ...
                    var f = Math.max(0, Math.min(255, Math.ceil(a * (c.getR() - b.getR()) + b.getR()))),
                        ...
                        h = Math.max(0, Math.min(255, Math.ceil(a * (c.getB() - b.getB()) + b.getB()))), i = {};
    ...
    STK.register("core.ani.transition", function (a) {
        ...
        return function (c, d) {
            var e = a.core.obj.parseParam({
                ...
                }, d), f = "all " + e.duration + "ms cubic-bezier(" + e.timingFn.join(",") + ")",
                g = a.core.dom.cssText(c.style.cssText), h = "test", i = b();
            g.merge(e.target);
            g.push("transition", f);
    ...
    STK.register("core.dom.sizzle", function (a) {
        ...
        var d = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,
            e = 0, f = Object.prototype.toString, g = !1, h = !0;
        [0, 0].sort(function () {
            h = !1;
            return 0
        });
        ...
        var j = {
            ...
            filter: {
                PSEUDO: function (a, b, c, d) {
                    ...
                    var c = b[1], d = j.attrHandle[c] ? j.attrHandle[c](a) : a[c] != null ? a[c] : a.getAttribute(c),
                        e = d + "", f = b[2], g = b[4];
    ...
    STK.register("core.evt.hitTest", function (a) {
        function b(b) {
            var c = STK.E(b), d = a.core.dom.position(c),
                e = {left: d.l, top: d.t, right: d.l + c.offsetWidth, bottom: d.t + c.offsetHeight};
            return e
        }
    ...
    STK.register("core.str.parseURL", function (a) {
        return function (a) {
            var b = /^(?:([A-Za-z]+):(\/{0,3}))?([0-9.\-A-Za-z]+\.[0-9A-Za-z]+)?(?::(\d+))?(?:\/([^?#]*))?(?:\?([^#]*))?(?:#(.*))?$/,
                c = ["url", "scheme", "slash", "host", "port", "path", "query", "hash"], d = b.exec(a), e = {};
    ...
    STK.register("core.util.URL", function (a) {
        return function (b, c) {
            var d = a.core.obj.parseParam({isEncodeQuery: !1, isEncodeHash: !1}, c || {}), e = {},
                f = a.core.str.parseURL(b), g = a.core.json.queryToJson(f.query), h = a.core.json.queryToJson(f.hash);
            ...
            e.valueOf = e.toString = function () {
                var b = [], c = a.core.json.jsonToQuery(g, d.isEncodeQuery),
    ...
    STK.register("core.io.require", function (a) {
        var b = "//js.t.sinajs.cn/STK/js/", c = function (a, b) {
    ...
    STK.register("core.str.queryString", function (a) {
        return function (b, c) {
            var d = a.core.obj.parseParam({source: window.location.href.toString(), split: "&"}, c),
                e = (new RegExp("(^|)" + b + "=([^\\" + d.split + "]*)(\\" + d.split + "|$)", "gi")).exec(d.source), f;
            return (f = e) ? f[2] : null
        }
    });
    STK.register("core.util.cookie", function (a) {
        var b = {
            set: function (b, c, d) {
                var e = [], f, g,
                    h = a.core.obj.parseParam({expire: null, path: "/", domain: null, secure: null, encode: !0}, d);
    ...
    STK.register("core.util.drag", function (a) {
        ...
        return function (d, e) {
            ...
            var f = a.core.obj.parseParam({actRect: [], actObj: {}}, e), g = {},
                h = a.core.evt.custEvent.define(f.actObj, "dragStart"),
                i = a.core.evt.custEvent.define(f.actObj, "dragEnd"),
                j = a.core.evt.custEvent.define(f.actObj, "draging"), k = function (d) {
                    var e = c({}, d);
    ...
    STK.register("core.util.htmlParser", function (a) {
        var b = function (a) {
            ...
            k = b("script,style"), l = function (a, b) {
    ...
    STK.register("core.util.nameValue", function (a) {
        return function (b) {
            var c = b.getAttribute("name"), d = b.getAttribute("type"), e = b.tagName, f = {name: c, value: ""},
                g = function (b) {
    ...
    (function (a) {
        ...
        "/ui": function (a, b, c, d) {
            ...
            var e = c("/css"), f = c("/helpers/toFunction"), g = {
            ...
            function t(a, b, c, d, e) {
                ...
                var f, g,
                    e = typeof arguments[arguments.length - 1] == "boolean" ? arguments[arguments.length - 1] : !1;
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.C, h = e.removeNode, i = e.removeEvent, j = e.addEvent,
                k = e.addClassName, l = e.removeClassName, m = e.foreach, n = f.setImmediate, o = {
            ...
            a.exports = function (a, b) {
                var c, d, f, g, h, i, j, k, l = function () {
                    ...
                    var d = g.t + (b.pageY - g.pageY), e = g.l + (b.pageX - g.pageX), h = d + g.height, i = e + g.width,
                        j = g.pageHeight - c.pagePadding[2], k = g.pageWidth - c.pagePadding[1];
            ...
            function j(a, b, c) {
                if (!!h(a)) {
                    var d = "fixed", g, i, j, k, l = a.offsetWidth, m = a.offsetHeight, n = e.core.util.winSize(),
                        o = 0, p = 0, q = e.core.dom.cssText(a.style.cssText);
                    if (!f) {
                        d = "absolute";
            ...
            a.exports = function (a) {
                var b = [].splice.call(arguments, 1, arguments.length), c = [a, $LANG].concat(b),
            ...
            var e = d("/core/theia") || STK, f = e.core.util.browser, g = {}, h = 5, i = 20, j = {
                t: function (a, b) {
                    return a.t > b.h
                }, b: function (a, b) {
                    return a.b > b.h
                ...
                domSize: function (a) {
                    ...
                    var g = k.domSize(b.layer), i = e.winSize().width, j = e.winSize().height, l = e.scrollPos(), m = 5,
                        n = 16, o, p, q, r, s, t, u = 0;
                    if (d == "t" || d == "b") {
                    ...
                    if (!b.node) throw"target node is undefined";
                    if (!b.layer) throw"layer node is undefined";
                    var c = k.getSeat(b.node, b.layer, b), d = c.area, f = c.rect, g = k.domSize(b.layer),
                        h = e.scrollPos(), i, j, l, m = e.winSize().width, n = g.w;
                    if (d == "t" || d == "b") {
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.core.json.merge, h = e.trim, i = e.E, j = e.isNode, k = "string",
                l = "object", m = "undefined";
            a.exports = p
            ...
            var e = c("/$")[0], f = c("/$")[1], g = c("/templates/layer.html"), h = c("/css"), i = f.layoutPos,
                j = f.parseDOM, k = f.language, l = f.fix, m = f.drag, n = f.extend, o = f.proxy, p = f.setImmediate,
                q = e.addEvent, r = e.removeEvent, s = e.stopEvent, t = e.fixEvent, u = e.addClassName,
                v = e.removeClassName, w = e.custEvent, x = e.core.json.merge, y = e.core.dom.position,
                z = e.core.dom.getSize, A = e.core.dom.setXY, B = e.core.dom.firstChild, C = e.builder,
                D = e.removeNode, E = e.contains, F = e.core.util.winSize, G = e.core.util.scrollPos,
                H = e.delegatedEvent, I = e.isNode, J = "string", K = "node-type", O = c("/Class_base").extend({
                    init: function (a) {
                        ...
                        b = b || {};
                        var c = b.pos || "bottom-middle", d = c.split("-"), e = this.getSize(), f = d[0], g = d[1],
                            h = b.offsetX || 0, i = b.offsetY || 0;
                        switch (f) {
                            case"top":
                                i -= e.height;
                                break;
                        ...
                        var a = F(), b = this.getSize(), c = G(), d = Math.max((a.height - b.height) / 2, 0) + c.top,
            ...
            var e = c("/$")[0], f = c("/$")[1], g = c("/mask"), h = c("/css"), i = e.C, j = e.builder,
                k = e.core.dom.firstChild, l = e.scrollPos, m = e.removeNode, n = e.foreach, o = e.arrIndexOf,
                p = e.addClassName, q = e.removeClassName, r = e.core.dom.hasClassName, s = e.hotKey, t = f.extend,
                u = f.proxy, v = [], w = document.body, x = document.documentElement, y = "UI_freezed", z = "px";
            ...
            var e = c("/$")[0], f = c("/$")[1], g = f.fix, h, i, j = [], k, l = !1, m = "STK-Mask-Key",
                n = e.core.dom.setStyle, o = e.core.dom.getStyle, p = e.core.evt.custEvent, s = {
                    getNode: function () {
                        return i
                    }, show: function (a, b) {
                        clearTimeout(h);
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.IE, h = f.extend, i = c("/templates/dialog.html"), j = f.proxy,
                k = e.addEvent, l = e.removeEvent, m = e.core.json.merge, n = e.core.dom.insertElement,
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.foreach, h = e.funcEmpty, i = e.custEvent, j = f.language,
                k = f.proxy, l = f.extend, m = c("/templates/alert.html"), n = c("/jsons/icons.json"),
                o = c("/helpers/render"), p = c("/Class_dialog").extend({
                    init: function (a) {
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.foreach, h = e.custEvent, i = e.funcEmpty, j = f.language,
                k = f.proxy, l = f.extend, m = c("/templates/confirm.html"), n = c("/jsons/icons.json"),
                o = c("/helpers/render"), p = c("/Class_dialog").extend({
                    init: function () {
                        p.__super__.init.apply(this, arguments);
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.foreach, h = e.funcEmpty, i = f.language, j = f.proxy,
                k = f.extend, l = c("/jsons/icons.json"), m = c("/templates/notice.html"), n = c("/helpers/render"),
                o = c("/Class_layer").extend({
                    init: function (a) {
                        o.__super__.init.apply(this, arguments);
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.C, h = e.replaceNode, i = e.core.dom.getSize, j = e.isNode,
                k = e.funcEmpty, l = e.getStyle, m = e.position, n = e.contains, i = e.core.dom.getSize,
                o = e.core.dom.insertElement, p = e.removeEvent, q = e.addEvent, r = f.proxy, s = f.extend,
                t = c("/templates/bubble.html"), u = 14, v = c("/Class_mlayer").extend({
                    init: function () {
                        ...
                        var d, e, f = this.getDomList(!0).arrow, g = this.getSize(),
                            h = {left: "right", top: "bottom", right: "left", bottom: "top"};
                        switch (a) {
                            case"top":
                        ...
                        b = b || {};
                        var c = b.pos || "top-middle", d = c.split("-"), e = b.offsetX || 0, f = b.offsetY || 0, g, h,
                            i = this.getSize();
                        switch (d[0]) {
                            case"top":
                                g = "bottom";
                        ...
                        c = s({
                            offset: {left: 0, top: 0}, arrowOffset: 0, align: "left", fail: r(function () {
                        ...
                        if (!!j(a) && !!j(b)) {
                            ...
                            g = m(f);
                            g || (g = {l: 0, t: 0});
                            var h = m(b), k = m(a), n = i(a), o = 6, p, q, t, v = c.offset, w = c.arrowOffset, x = i(d),
                                y = i(b), z = 2;
                            if (c.align === "left") {
            ...
            var e = c("/$")[0], f = c("/$")[1], g = f.rects, h = f.setImmediate, i = f.proxy, j = f.extend,
                k = c("/css"), l = {
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.foreach, h = e.funcEmpty, i = e.core.dom.uniqueID, j = f.language,
                k = f.proxy, l = f.extend, m = c("/templates/tipAlert.html"), n = c("/jsons/icons.json"),
                o = c("/helpers/render"), p = {}, q = c("/Class_bubble").extend({
                    init: function (a) {
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.foreach, h = e.funcEmpty, i = e.core.dom.uniqueID,
                j = e.custEvent, k = f.language, l = f.proxy, m = f.extend, n = c("/templates/tipConfirm.html"),
                o = c("/jsons/icons.json"), p = c("/helpers/render"), q = {}, r = c("/Class_bubble").extend({
                    init: function (a) {
            ...
            var e = c("/$")[0], f = c("/$")[1], g = c("/css"), h = e.C, i = e.addClassName, j = e.removeClassName,
                k = e.builder, l = e.addEvent, m = e.removeEvent, n = e.removeNode, o = e.fixEvent, p = e.stopEvent,
                q = e.core.util.browser.IE6 || e.core.util.browser.IE7, r = f.parseDOM,
            ...
            function m(a, b, c) {
                if (h.effectSuport) {
                    ...
                    var f = parseInt(g(a, "line-height")),
                        m = i(l(k, {oldValue: d, newValue: e, height: (f || a.offsetHeight) - 1})), n = m.list.t[0],
                        o = m.box;
                    a.innerHTML = "";
                    a.appendChild(o);
            ...
            var e = c("/$")[0], f = c("/$")[1], g = e.getStyle, h = c("/css"), i = e.builder, j = e.contains,
                k = c("/templates/badge.html"), l = c("/helpers/render");
            a.exports = m
            ...
            var e = c("/$")[0], f = c("/$")[1], g = c("/Class_mlayer"), h = c("/css"), i = e.C, j = e.addClassName,
                k = e.removeClassName, l = e.core.dom.hasClassName, m = e.addEvent, n = e.removeEvent, o = e.builder,
                p = e.foreach, q = e.fixEvent, r = e.preventDefault, s = e.stopEvent, t = e.getUniqueKey,
                u = e.custEvent, v = f.parseDOM, w = f.extend, x = f.proxy,
                y = {ENTER: 13, ESC: 27, UP: 38, DOWN: 40, LEFT: 37, RIGHT: 39}, A = c("/Class_mlayer").extend({
                    init: function () {
                        A.__super__.init.apply(this, arguments);
                        u.define(this, ["suggest", "submit"]);
                        var a = this._, b = a.input, c = a.proxyShow = x(this.show, this),
                            d = a.proxyHide = x(this.hide, this), e = a.proxyKey = x(function (a) {
                                a = q(a);
                                var c, d;
            ...
            var e = d("/core/theia") || STK, f = null, g = e.custEvent, h = g.define, i = g.fire, j = g.add,
                k = e.addEvent, l = e.removeEvent, m = e.stopEvent, n = [], o = {},
                p = {ENTER: 13, ESC: 27, UP: 38, DOWN: 40, TAB: 9}, q = function (a) {
                    var b = -1, c = [], d = a.textNode, f = a.uiNode, g = e.core.evt.delegatedEvent(f),
                ...
                var c = {}, d = {}, h, i, j, k, l, m, n = !1, o = !1, p = e.core.dom.setStyle, q = {
                    ...
                    slideDot: function (a, c) {
                        ...
                        var d = c.toPage - c.currentPage > 0 ? c.toPage - c.currentPage : c.totalPage - c.currentPage + c.toPage,
                            f = (b.eleWidth + b.eleMargin) * Math.abs(d), g = c.speed || b.speed_tween;
                        k = e.core.ani.tween(i, {
                            animationType: b.tween_algorithm, duration: g, end: function () {
    ...
    (function () {
        ...
        a.register("core.util.URL", function (a) {
            return function (c, d) {
                var e = a.core.obj.parseParam({isEncodeQuery: !1, isEncodeHash: !1}, d || {}), f = {},
                    g = a.core.str.parseURL(c), h = a.core.json.queryToJson(g.query),
                ...
                f.valueOf = f.toString = function () {
                    var c = [], d = a.core.json.jsonToQuery(h, e.isEncodeQuery),
        ...
        a.register("common.util.request", function (a) {
            ...
            return function (d) {
                ...
                var e = b.createIframe(), f, g = function () {
                    try {
                        var i = e.contentWindow, j = i.location.href, k = b.getDocOfIframe(e),
    ...
    function SSOController() {
        var undefined, me = this, updateCookieTimer = null, updateCookieTimeHardLimit = 1800,
            ...
            generateVisitorUrl = "https://passport.weibo.com/visitor/visitor", crossDomainUrlList = null,
            loginMethod = "", ssoServerTimeTimer = null, ssoLoginTimer = null, loginByConfig = null,
            loginMethodCheck = null, https = 1, rsa = 2, wsse = 4, pcid = "", tmpData = {}, preloginTimeStart = 0,
            preloginTime = 0, callbackLogoutStatus;
        this.https = 1;
        this.rsa = 2;
        this.wsse = 4;
        ...
        (function () {
            var a = function () {
                ...
                d = {vsnf: "vsnf", vsnval: "vsnval", door: "door", setCookie: "s", ssoSimpleLogin: "ssosimplelogin"},
                e = {}, f = {}, g = function (a, b) {
                    var c, d = {};
                    a = a || {};
                    b = b || {};
        ...
        this.appLogin = function (a, b, c) {
            var d = tmpData.savestate ? parseInt((new Date).getTime() / 1e3 + tmpData.savestate * 86400) : 0,
                e = getCookie("ALF") ? getCookie("ALF") : 0, f = {callback: c, ticket: a, ssosavestate: d || e},
        ...
        var makeNonce = function (a) {
            ...
            var e = createForm(me.loginFormId), f = makeRequest(a, b, c, d);
            f.encoding = "UTF-8";
            ...
            var i = makeURL(ssoLoginUrl, objMerge({client: me.getClientType()}, me.loginExtraFlag));
            e.method = "post";
            e.action = i;
    ...
    (function () {
        ...
        function H(a, b, c) {
            ...
            if (!(f.t <= 0)) {
                ...
                var l = h.t, m = h[l - 1];
                if (m == 0) return;
                var n = m * (1 << this.F1) + (l > 1 ? h[l - 2] >> this.F2 : 0), o = this.FV / n, p = (1 << this.F1) / n,
                    q = 1 << this.F2, r = c.t, s = r - l, t = b == null ? e() : b;
                h.dlShiftTo(s, t);
                if (c.compareTo(t) >= 0) {
                    c[c.t++] = 1;
                    c.subTo(t, c)
    ...
    STK.register("v6.pub.plugin.sso.loginbridge", function (a) {
        var b = window.sinaSSOController, c = a.v6.conf.channel.sso.login, d = {
            savestate: 0,
            vsnf: 0,
            hold_login_state: !1,
            cookie_timeout: 0,
    ...
    STK.register("v6.pl.open.loginlayer.source.pluginloader", function (a) {
        var b = !1;
        return function (c) {
            var d = {desktop: !1, login: !1, qrcode: !1}, e = {
                vsnf: 1,
                hold_login_state: !1,
                cookie_timeout: 0,
                entry: "weibo",
    ...
    STK.register("v6.lib.kit.extra.jsPath", function (a) {
        var b = {path: $CONFIG.jsPath || "//js.t.sinajs.cn/t5/", mPath: $CONFIG.mJsPath}, c, d = function () {
            c = [""];
    ...
    STK.register("v6.lib.kit.extra.cssPath", function (a) {
        var b = {path: $CONFIG.cssPath || "//img.t.sinajs.cn/t6/", mPath: $CONFIG.mCssPath}, c, d = function () {
            c = [""];
            for (var a = b.mPath[1]; a <= b.mPath[2]; a++) c.push(a.toString())
        }, e = function () {
            if (typeof b.mPath != "undefined") {
    ...
    STK.register("v6.lib.kit.io.cssLoader", function (a) {
        var b = "", c = "//img.t.sinajs.cn/t4/", d = "//timg.sjs.sinajs.cn/t4/";
        if (typeof $CONFIG != "undefined") {
            c = $CONFIG.cssPath || c;
            b = $CONFIG.version || ""
        }
    ...
    STK.register("v6.pub.ui.tipAlert", function (a) {
        return function (b) {
            var c,
                d = '<div class="Bv6_layer Bv6_layer_pop">\n\t<div class="content layer_mini_info">\n\t\t<p class="main_txt">\n\t\t\t<span node-type="icon"></span>\n\t\t\t<span node-type="text"></span>\n\t\t</p>\n\t\t<div node-type="otherText"></div>\n\t\t\n\t\t<div class="W_layer_arrow">\n\t\t\t<span node-type="arrow" class="W_arrow_bor"><i class="S_line3"></i><em class="S_bg2_br"></em></span>\n\t\t<div>\n\t</div>\n</div>',
                e = {
                    init: function () {
                    }, show: function (b, e) {
                        e = a.parseParam({
    ...
    STK.register("kit.extra.language", function (a) {
        window.$LANG || (window.$LANG = {});
        return function (b) {
            var c = [].splice.call(arguments, 1, arguments.length), d = [b, $LANG].concat(c),
                e = a.core.util.language.apply(this, d);
            return e
        }
    });
    STK.register("common.layer.emailAutocomplete", function (a) {
        var b = a.kit.extra.textareaUtils, c = a.kit.extra.language,
            ...
            g = [/^[0-9a-z_][_.0-9a-z-]{0,31}$/, /^[0-9a-zA-Z_][_.0-9a-zA-Z-]{0,31}$/], h = {};
        return function (b, i) {
            var j, k, l, m, n, o, p, q = !1, r = {
                ...
                build: function () {
                    ...
                    var c = a.core.dom.position(b), d = a.core.dom.getSize(b),
    ...
    STK.register("common.setting.dataType", function (a) {
        var b = a.kit.extra.language, c = {
            msg: {id: "", state: !0, type: "empty", code: "", action: "", msg: "", iodata: null, iorecords: !1},
            initPars: {
                text: "",
                hook: null,
                type: "",
    ...
    STK.register("v6.pub.login.form", function (a) {
        var b = ["username", "password", "verifycode", "vsncode"], c = a.core.util.templet,
            d = a.v6.conf.channel.sso.login, e = a.v6.pub.form.verifycodeSSO, f = a.core.evt.hotKey,
            g = a.kit.extra.textareaUtils,
            h = $CONFIG && $CONFIG.register_url || "//weibo.com/signup/signup.php" + (Boolean(a.URL(window.location.href).getParam("c")) ? "?backurl=" + encodeURI(window.location.href) : ""),
            i = {
                ...
                SUBMIT: {NORMAL: "<em>#L{登录}</em>", ONSUBMIT: '<i class="W_loading"></i><em>#L{登录}</em>'},
                ...
                if (!n) {
                    n = [];
                    for (var c in i.ERRTIP.CODE) n.push(c)
                }
                return a.inArray("" + b, n)
            };
        return function (f, h) {
            var n, p, q, r, s = {}, t, u, v, w = {yalogin: !1, nopwd: !1, unChecked: !1}, x = {
                init: function () {
                    x.parseParam();
                    x.parseDOM();
                    x.initPlugin();
                    ...
                    y.destroy();
                    v.destroy();
                    for (var a in s) s[a] && clearTimeout(s[a]);
                ...
                init: function () {
                    ...
                    var c;
                    for (var d in q) a.inArray(d, b) && k[d] && y.item(d);
                    ...
                    for (var c in C) if (C[c].isVisible()) {
                        C[c].reset();
                        break
                    }
                    if (!a.password.state) {
                    ...
                    if (!q.prename_box) y.usernameBox(); else if (a.isNode(a.kit.dom.firstChild(q.prename_box))) {
                    ...
                    for (var b in C) typeof a != "undefined" && a == b ? C[b].isVisible() ? C[b].reset() : C[b].enable() : C[b].isVisible() && C[b].disable()
                }, resetVerifycode: function (b) {
                    b && a.preventDefault(b.evt);
                    C.verifycode.reset();
                    return !1
                }, lock: function (b) {
                    if (typeof b != "undefined" && p.ctls[b]) a.getStyle(q[b + "_box"], "display") != "none" && !p.ctls[b].pars.disabled && p.ctls[b].disabled(1); else for (var b in p.ctls) a.getStyle(q[b + "_box"], "display") != "none" && !p.ctls[b].pars.disabled && p.ctls[b].disabled(1)
                }, unlock: function () {
                    for (var b in p.ctls) a.getStyle(q[b + "_box"], "display") != "none" && p.ctls[b].pars.disabled && p.ctls[b].disabled(0)
                }, remember: {
                    mark: function () {
                ...
                enter: function (b) {
                    ...
                    if (b.keyCode === 13) {
                        ...
                        for (var e in p.ctls) if (e != d && !p.ctls[e].pars.disabled && c[e].state == !1) {
                            setTimeout(function () {
                                g.setCursor(q[e])
                            }, 0);
                            return
                ...
                login: {
                    complete: function () {
                        ...
                        var d;
                        if (b.code == "2071") if ("protection_url" in b && b.protection_url) {
                        ...
                        o(b.code) ? d = c(i.ERRTIP.CODE["" + b.code], {USERNAME: p.ctls.username.value()}) : d = !b.reason || b.reason === "" ? i.ERRTIP.CODE[9999] + "(" + b.code + ")" : b.reason;
                        var j = {};
                        j[b.type] = {msg: d, state: !1};
                        y.errTip.show(j, 1)
                    }
                }, logout: {
                    complete: function () {
                    ...
                    complete: function (b) {
                        ...
                        if (b.code && b.code == 4098) {
                            var c = {};
                            c[b.type] = {msg: i.ERRTIP.CODE["" + b.code], state: !1};
                            y.errTip.show(c);
                            w.nopwd = !0
                        }
                        if (b.is_openlock === 1 && !("not_tab_qrcode" in b && b.not_tab_qrcode == 1)) {
                            y.errTip.show({username: {msg: i.ERRTIP.CODE[2071]}});
                            var d = f.parentNode;
    ...
    STK.register("ui.mod.layer", function (a) {
        ...
        return function (d) {
            var e = a.core.dom.builder(d), f = e.list.outer[0], g = e.list.inner[0], h = a.core.dom.uniqueID(f), i = {},
    ...
    STK.register("v6.pub.login.qrcode", function (a) {
        return function (b, c) {
            var d, e, f, g, h = a.kit.extra.language, i = a.v6.conf.channel.sso.qrcode, j = !0,
                k = {scanSucc: h('<div node-type="outer" style="width:208px" class="layer_form_tips"><div class="bg"><div node-type="inner" class="content qrcode_tips"><a class="W_ico12 icon_close" node-type="close"></a><div class="W_tips empty clearfix"><p class="icon"><span class="icon_succ"></span></p><p class="txt">#L{扫描成功}！<br>#L{点击手机上的确认即可登录}</p></div></div><div class="arrow arrow_tips"></div></div>')},
                l = function (b) {
                    ...
                    if (!b) return a.common.extra.parseLanguage(c);
                    switch (b) {
                        case"qrcode_used":
                    ...
                    var c = '<span class="W_icon icon_rederrorB"></span><div class="res_info">#text#</div>', d = "";
                    switch (b) {
                        case"-4098":
                    ...
                    init: function () {
                        ...
                        for (var c in n.handle) i.register(c, n.handle[c]);
                        ...
                        getQRcode_success: function (a) {
                            ...
                            if (!c.isLayer) {
                                ...
                                var b = m(""), e = a && a.retcode ? a.retcode : "0";
                                if (e == "4069") {
                                    var g = a.msg.split("|");
                                    if (g.length == 2 && g[1]) {
                ...
                }, o = {enable: n.enable, disable: n.disable};
            n.init();
            return o
        }
    });
    STK.register("common.setting.mobile", function (a) {
        var b = {E01: "", E02: "#L{目前支持大陆、港澳台手机号注册}", E03: "#L{请输入手机号码}", E04: "#L{手机号长度11位，以13/14/15/16/17/18/19开头}"};
        return function (c, d) {
            var e = function () {
                var a = g.value(), b = !1;
                if (!g.pars.must && g.rule.isEmpty(a)) {
    ...
    STK.register("v6.conf.trans.sso.message", function (a) {
        ...
        c("send_sms", {url: "//login.sina.com.cn/sso/msglogin", requestMode: "jsonp", varkey: "callback"});
        return b
    });
    STK.register("v6.pub.login.message", function (a) {
        var b = ["mobile", "activation"], c = a.core.util.templet, d = a.v6.conf.channel.sso.login,
            e = a.v6.conf.trans.sso.message, f = a.kit.extra.textareaUtils, g = {
                TIPS: {
                ...
                ERRTIP: {CODE: a.common.form.ssoErrCode},
                SUBMIT: {NORMAL: "#L{登录}", ONSUBMIT: '<i class="W_loading"></i>#L{登录}'}
            }, h = function () {
                var a, b = {
                    save: function (b) {
                        a = b
        ...
        return function (i, k) {
            var l, m, n, o, p, q, r = {}, s = {unChecked: !1}, t = null, u = {
                ...
                init: function () {
                    ...
                    for (var b in l.ctls) (!m[b + "_box"] || a.getStyle(m[b + "_box"], "display") != "none") && l.ctls[b].pars.disabled && l.ctls[b].disabled(0)
                }, submit: {
                    active: function () {
                        r.checkUsername && clearTimeout(r.checkUsername);
                        v.errTip.hide();
                        ...
                        e.getTrans("send_sms", {
                            onComplete: function (a) {
                                ...
                                if (a.retcode == 2e7) {
                                    ...
                                    if (a.retcode == 50110810 || a.retcode == 50110811) b = {
                                        activation: {
                                            state: !1,
    ...
    STK.register("v6.pub.dialog.login", function (a) {
        var b = document.location.protocol == "https:" ? "https:" : "http:", c = {
            ...
            e = a.v6.conf.core.ui.dialog({template: c.DIALOG_FRAME, isHold: !0}), f = e.getDomList().inner;
        return function (b) {
            function q(a) {
                a = a || window.event;
                if (o(a, d.qrcode_src)) {
            ...
            var d, g, h = null, i = null, j = null, k, l, m = {
                init: function () {
                    ...
                    e.setContent(a.core.util.templet(c.FRAME, {MESSAGE_LOGIN_LINK: m.is.visitor() ? "" : c.MESSAGE_LOGIN_LINK}) + m.extdata());
                    d = a.kit.dom.parseDOM(a.builder(f).list);
                    e.show();
                    m.handle.change("login")
                }, bind: function () {
                    g = a.delegatedEvent(f);
                    for (var b in m.domEvts) g.add(b, "click", m.domEvts[b]);
                    ...
                    otherForm: function () {
                        ...
                        i || (i = a.v6.pub.login.qrcode(d.qrcode_frame, {isLayer: !0}));
                        i.enable();
                        m.handle.loginFocus()
                    }, loginForm: function () {
    ...
    STK.register("v6.pl.open.loginlayer.source.main", function (a) {
        ...
        return function (d) {
            ...
            e.randVersion = function (a) {
                ...
                for (var e = 0; e < a; e++) d.push(b.charAt(Math.floor(Math.random() * c)));
                return d.join("")
            };
